    ...
    public PaperOnboardingEngine(View rootLayout, ArrayList<PaperOnboardingPage> contentElements, Context appContext) {
        ...
        mRootLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                /*mPagerIconsContainer.setY((mContentRootLayout.getHeight() - mContentCenteredContainer.getHeight()) / 2);
                mPagerIconsContainer.setX((mContentRootLayout.getHeight() - mContentCenteredContainer.getHeight()) / 2);
*/
...
*/
    ...
    protected void toggleContent(boolean prev) {
        ...
        int newPagerPosX = ((mContentRootLayout.getHeight() - mContentCenteredContainer.getHeight()) / 2);
    ...
    protected AnimatorSet createPagerIconAnimation(int oldIndex, int newIndex) {
        ...
        oldActiveShape.setImageResource(oldIndex - newIndex > 0 ? R.drawable.onboard_non_selected : R.drawable.onboard_non_selected);
